...
const navItems = [
  {
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/6db280fcc9589d8357036341b4443dc3aab75bc0c3268150277f0f16c69490ac?placeholderIfAbsent=true&apiKey=847064471252402daefe7a4367a8e307",
    text: "Dashboard",
    to: "/dashboard",
    active: false,
  },
  {
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/644fce53a554d26a8b74ad8665c18ef1fd16094e65c6552f6e966c667332a560?placeholderIfAbsent=true&apiKey=847064471252402daefe7a4367a8e307",
    text: "Volunteers",
    to: "/admin/meetings",
    active: false,
  },
  {
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/1337e7165bbb4c98d7f6fe5479e1ee9ca2ed4690eb2a3f3265215b55c5114df5?placeholderIfAbsent=true&apiKey=847064471252402daefe7a4367a8e307",
    text: "Meetings",
    to: "/admin/new",
    active: true,
  },
  {
    icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/5313e5b24a041495977375b19049da4e7367b42ac5494c6648b6d3ed76a35f65?placeholderIfAbsent=true&apiKey=847064471252402daefe7a4367a8e307",
    text: "Reports",
    to: "/reports",
    active: false,
  },
      ...
      <div className="flex z-10 flex-col grow mt-7 mr-0 max-md:max-w-full">
        <div className="flex flex-col  max-w-full w-[327px] ">
          {navItems.map((item, index) => (
            <NavItem key={index} icon={item.icon} text={item.text} to={item.to} active={item.active} />
          ))}
          <button className="flex flex-col justify-center self-center p-1.5 max-w-full text-sm font-semibold bg-black bg-opacity-0 mt-[498px] text-slate-100 w-[298px] max-md:mt-2">
