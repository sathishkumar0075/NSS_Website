...
function AttendanceItem({ name, branch, year_of_study }) {
  return (
    <div className="flex z-10 gap-4 self-stretch py-3 pr-10 pl-5 mt-4 font-semibold bg-black bg-opacity-0 max-md:pr-5 max-md:mr-1">
      ...
      <div className="flex flex-col my-auto">
        <div className="self-start text-base text-zinc-600">{name}</div>
        <div className="mt-3 text-xs text-gray-400">{branch}</div>
        <div className="mt-3 text-xs text-gray-400">{year_of_study}</div>
