...
const Hero = () => {
  return (
    <section className="flex relative flex-col justify-center items-start px-12 py-44 mt-16 w-full rounded-3xl min-h-[707px] max-md:px-5 max-md:py-24 max-md:mt-10 max-md:max-w-full">
      <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/5cd24678eeb2cddbbb8a22ac4c208578f6eefb22f276e4ab037e2b4f20ac0fc6?placeholderIfAbsent=true&apiKey=847064471252402daefe7a4367a8e307" alt="Background" className="object-cover absolute inset-0 size-full" />
